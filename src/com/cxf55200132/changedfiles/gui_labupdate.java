...
//BufferedReader in = new BufferedReader( new InputStreamReader (System.in));
   ...
   /*  Get the department number from the input data */
    ...
    //s = in.readLine();
	s = JOptionPane.showInputDialog(null,"which department you want to modify: ");
   ...
   try 
   {
     ...
     /*                                                                     */
     /***********************************************************************/
	 PreparedStatement ps    = sample.prepareStatement(sqlstmt);
     //????????????????? ????? = ??????.????????????????( sqlstmt );                  
	...
	JOptionPane.showMessageDialog(null,"Successfully changed "+updateCount+" lines!");
